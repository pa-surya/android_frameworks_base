...
public class DataUsageController {
    ...
    public DataUsageInfo getWifiDataUsageInfo(String ssid) {
        return getDataUsageInfo(getWifiNetworkTemplate(ssid));
    }

    public DataUsageInfo getWifiDataUsageInfo() {
        return getWifiDataUsageInfo(null);
    }

    public DataUsageInfo getWifiDailyDataUsageInfo(String ssid) {
        return getDailyDataUsageInfo(getWifiNetworkTemplate(ssid));
    }

    public DataUsageInfo getWifiDailyDataUsageInfo() {
        return getWifiDailyDataUsageInfo(null);
    }

    public NetworkTemplate getWifiNetworkTemplate(String ssid) {
        if (ssid != null && !ssid.isEmpty() && !ssid.equals(WifiManager.UNKNOWN_SSID)) {
            return NetworkTemplate.buildTemplateWifi(ssid);
        }
